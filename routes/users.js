...
router.post("/login", function (req,res,next) {
    User.findOne({userName:req.body.userName}, function (error, doc) {
        if (!doc) {
            ...
            if(req.body.userPwd == doc.userPwd){
...
router.post("/reg", function (req,res,next) {
    ...
    var userPPwd = req.body.userPPwd;
    if(userPwd != userPPwd){
        return res.json({
            status:"1",
            msg:'密码错误'
...
// 修改商品数量
router.post("/changeCount", function (req,res,next) {
    var _id = req.body.userId,
...
router.post("/upload", function (req,res,next) {
    ...
    form.encoding='utf-8';
    form.uploadDir='../dongman/static/headImg';
    ...
    form.parse(req,function (err,fields,files) {
        ...
        var dstPath = '../dongman/static/headImg/' + req.session.userName +'.jpg';
